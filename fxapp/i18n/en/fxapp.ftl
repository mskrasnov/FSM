...
drm-unknown = <unknown>
drm-model = Model
drm-resol = Resolution, max.
drm-aspratio = Aspect ratio
drm-diag = Diagonal
drm-pixclck = Pixel clock
drm-extblcks = Extension blocks
drm-cksum = Checksum
drm-edid-raw = EDID raw value
drm-no-dtb = No DTB blocks
drm-h-active = Horizontal resolution
drm-v-active = Vertical resolution
drm-h-blanking = Horizontal blanking interval
drm-v-blanking = Vertical blanking interval
drm-h-front-porch = Horizontal front porch
drm-h-sync-pulse = Horizontal sync pulse width
drm-v-front-porch = Vertical front porch
drm-v-sync-pulse = Vertical sync pulse width
drm-h-back-porch = Horizontal back porch
drm-v-back-porch = Vertical back porch
drm-h-sync-pos = Horizontal sync pulse is positive polarity
drm-v-sync-pos = Vertical sync pulse is positive polarity
drm-dtdb = Detailed Timing Descriptor block #{$idx}
drm-rl = Range Limits
drm-no-rl = No Range Limits found
drm-min-v-freq = Minimum vertical field rate
drm-max-v-freq = Maximum vertical field rate
drm-min-h-freq = Minimum horizontal line rate
drm-max-h-freq = Maximum horizontal line rate
drm-max-pixclck = Maximum supported pixel clock
